...
from info.models.layer.anti_aliasing import AntiAliasDownsampleLayer
from info.models.layer.avg_pool import FastAvgPool2d
from info.models.layer.general_layers import SEModule, SpaceToDepthModule
from info.models.backbone import backbone
...
@backbone("TResnetM")
def TResnetM(cfg):
    r"""Constructs a medium TResnet model.
    """
    in_chans = 3
    do_bottleneck_head = cfg.do_bottleneck_head
...
@backbone("TResnetL")
def TResnetL(cfg):
    r"""Constructs a large TResnet model.
    """
    in_chans = 3
    num_classes = cfg.num_classes
    do_bottleneck_head = cfg.do_bottleneck_head
...
@backbone("TResnetXL")
def TResnetXL(cfg):
    r"""Constructs a xlarge TResnet model.
    """
    in_chans = 3
    num_classes = cfg.num_classes
